...
w2v_vocab = list(w2v_model.key_to_index.keys())  # Use .key_to_index instead of .vocab.keys()
w2v_vocab_dict = {word: "" for word in w2v_vocab}
for v in tqdm(vocab, "Processing pretrained vectors"):
    try:
        if v in w2v_vocab_dict:  # Check if the word is in the pretrained vocabulary
